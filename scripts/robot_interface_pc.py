...
def robot_interface():
	...
	rospy.Subscriber('robot_position', Vector3, callback)
...
def guardar():
	...
	print(recorrido)
	#np.savetxt('/home/robotica/catkin_ws/src/taller3_pkg/results/'+nom.get()+'.txt',recorrido,fmt="%s")

def guardarGraf():
	plt.title(nomGraf.get())
	plt.savefig('/home/robotica/catkin_ws/src/taller3_pkg/results/'+nomGraf.get()+'.png')
